...
void AccountSettings::Init()
{
	...
	ptr = str.GetBuffer(255);
	GetPrivateProfileString(section, _T("disableOutgoing"), _T("1"), ptr, 256, iniFile);
	str.ReleaseBuffer();
	disableOutgoing = _wtoi(str);
...
// save user settings
	...
	// Persist outbound calling policy
	WritePrivateProfileString(section, _T("disableOutgoing"), disableOutgoing ? _T("1") : _T("0"), iniFile);
#ifdef _GLOBAL_VIDEO
